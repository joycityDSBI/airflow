...
with DAG(
    ...
    def etl_f_IAA_game_sub_user_watch(target_date: list):
        ...
        for td in target_date:
            ...
            (
                ...
                WHERE WorldID <= 900
                AND Reason = 511
                AND LogDate_Svr >= '2025-11-15'
                AND LogDate_Svr < '2025-11-16'
                AND p0 != 0
                ...
                AND logdate >= '2025-11-15'
                AND logdate < '2025-11-16'
                GROUP BY joyple_game_code, watch_datekey, game_sub_user_name 
            ...
            ) AS source ON target.joyple_game_code = source.joyple_game_code AND target.game_sub_user_name = source.game_sub_user_name AND target.watch_datekey = source.watch_datekey   
              ...
              revenue_per_user_KRW
                ...
                FROM (
                    ...
                    FROM (
                        ...
                        WHERE DATE(event_time) >= DATE('2025-11-18', "Asia/Seoul")
                        AND DATE(event_time) <  DATE('2025-11-26', "Asia/Seoul")
    ...
    def etl_f_IAA_auth_account_performance(target_date:list):
        ...
        for td in target_date:
            ...
            # KST
            start_utc = (target_date - timedelta(days=30)).replace(tzinfo=kst).astimezone(pytz.UTC)
            end_utc = (target_date + timedelta(days=1)).replace(tzinfo=kst).astimezone(pytz.UTC)
            ...
            WITH InAppADPerformance
                ...
                WHERE watch_datekey >= DATE('2025-11-15', "Asia/Seoul")
                    AND watch_datekey <  DATE('2025-11-16', "Asia/Seoul")
                    AND revenue != 0
                ...
                WHERE a.watch_datekey >= DATE('2025-11-15', "Asia/Seoul")
                    AND a.watch_datekey <  DATE('2025-11-16', "Asia/Seoul")
