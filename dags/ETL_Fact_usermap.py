...
def etl_f_user_map(target_date:list, client):
    ...
    for td in target_date:
        ...
        , source.reg_market_id
        , source.reg_os_id
        , source.reg_platform_device_type
        , source.install_datekey
        , source.datediff_install
        ...
        , source.CB3_campaign 
        , source.daily_total_rev
        , source.daily_buy_cnt
        , source.daily_pu
        , source.stacked_rev
        , source.stacked_buy_cnt
        , source.stacked_rev_percent_rank
        , source.monthly_rev
        , source.monthly_rgroup
        , source.before_monthly_rev
        , source.before_monthly_rgroup
        , source.yearly_rev
        , source.last_30days_rev
        , source.first_payment_datekey
        , source.last_payment_datekey
        , source.stacked_IAA_watch_cnt
        , source.stacked_IAA_rev
        , source.daily_IAA_watch_cnt
        , source.daily_IAA_rev
        , source.monthly_IAA_rev
        , source.play_seconds
        , source.access_cnt
        , source.daily_game_user_level
        , source.last_login_datekey
        , source.max_game_user_level
        , source.datediff_last_login
        , source.stickiness
        , source.NRPU
        , source.game_sub_user_name_cnt
...
def etl_f_user_map_char(target_date:list, client):
    ...
    for td in target_date:
        ...
        (
                    ...
                    source.datediff_sub_user_reg, 
                    source.game_sub_user_reg_datetime, 
                    source.reg_datekey, 
                    source.datediff_reg,
                    source.daily_total_rev, 
                    source.daily_buy_cnt, 
                    source.daily_pu, stacked_rev, 
                    source.stacked_buy_cnt, 
                    source.stacked_rev_percent_rank, 
                    source.monthly_rev,
                    source.monthly_rgroup_sub_user, 
                    source.before_monthly_rev, 
                    source.before_monthly_rgroup_sub_user, 
                    source.yearly_rev, 
                    source.last_30days_rev,
                    source.first_payment_datekey, 
                    source.last_payment_datekey, 
                    ...
                    source.max_game_user_level, 
                    source.last_login_datekey, 
                    source.datediff_last_login_sub_user, 
                    source.stickiness, 
                    source.products_array,
                    source.install_country_code, 
                    source.install_datekey, 
                    source.app_id, media_source, 
                    source.bundle_id, 
                    source.is_organic, 
                    source.agency, 
                    source.campaign, 
...
def etl_f_user_map_test(target_date: list, client):
...
def etl_f_user_map_char_test(target_date: list, client):
