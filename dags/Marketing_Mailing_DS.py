...
with DAG(
    dag_id='Marketing_Mailing_DS',
    default_args=default_args,
    description='DS 마케팅 결과를 메일링',
    schedule='03 5 * * *',
    start_date=datetime(2025, 1, 1),
    catchup=False,
    tags=['marketing', 'mailing', 'DS'],
) as dag:
    ...
    def extract_and_send_email(**context):
        ...
        try:
                                ...
                                <tbody>
                                    <tr>
                                        <td style="white-space: nowrap" class="tableTitleNewMain">
                                            📊 DS UA Performance & Cost Report :: {current_time} (KST)
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            msg['Subject'] = f"[DS] UA Performance & Cost Report {today}"
