...
with DAG(
    ...
    basic_query = f"""
            ...
            , case when CountryCode = 'US' then '1.US'
                ...
                when CountryCode = 'TW' then '5.TW'
                else '6.ETC' end as geo_user_group 
            from(select *
            ...
            from (
                select  * , case when CountryCode = 'US' then '1.US'
                when CountryCode = 'JP' then '2.JP'
                when CountryCode in ('UK','FR','DE','GB') then '3.WEU'
                when CountryCode = 'KR' then '4.KR'
                when CountryCode = 'TW' then '5.TW'
    ...
    def extract_and_send_email(**context):
        ...
        try:
            ...
            df_all_tw = df_all_geo[df_all_geo['Country'] == '5.TW']
            df_all_etc = df_all_geo[df_all_geo['Country'] == '6.ETC']
            ...
            html_table_header_all_tw, html_table_rows_all_tw = format_table(df_all_tw)
            ...
            df_non_tw = df_non_geo[df_non_geo['Country'] == '5.TW']         
            ...
            html_table_header_non_tw, html_table_rows_non_tw = format_table(df_non_tw)
            ...
            genai_all_tw = genai_paid_geo_analytics(df_all_tw, credentials)
            genai_all_etc = genai_paid_geo_analytics(df_all_etc, credentials)
            genai_all = genai_paid_all_analytics(df_all, credentials, genai_all_us + genai_all_jp + genai_all_weu + genai_all_kr + genai_all_tw + genai_all_etc)
            ...
            genai_non_tw = genai_organic_geo_analytics(df_non_tw, credentials)
            genai_non_etc = genai_organic_geo_analytics(df_non_etc, credentials)
            genai_non = genai_organic_all_analytics(df_non, credentials, genai_non_us + genai_non_jp + genai_non_weu + genai_non_kr + genai_non_tw + genai_non_etc)
            ...
            html_body = f"""<!DOCTYPE html>
                        ...
                        <body>
                            ...
                            <table border="1" width="100%">
                                <tbody>
                                    <tr>
                                        <td style="white-space:nowrap" class="tableTitleNew1">전체 유저(TW) 조회 기간: {two_weeks_ago} ~ {yesterday} | 총 행 수: {len(df_non_tw)}</td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table border="1" width="100%">
                                <tbody>
                                    {html_table_header_non_tw}
                                    {html_table_rows_non_tw}
                                </tbody>
                            </table>
                            ...
                            <table border="1" width="100%">
                                <tbody>
                                    <tr>
                                        <td style="white-space:nowrap" class="tableTitleNew1">Android Paid User(TW) 조회 기간: {two_weeks_ago} ~ {yesterday} | 총 행 수: {len(df_all_tw)}</td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table border="1" width="100%">
                                <tbody>
                                    {html_table_header_all_tw}
                                    {html_table_rows_all_tw}
                                </tbody>
                            </table>
