...
with DAG(
    dag_id='Marketing_Mailing_POTC',
    default_args=default_args,
    description='POTC 마케팅 결과를 메일링',
    schedule='02 5 * * *',
    start_date=datetime(2025, 1, 1),
    catchup=False,
    tags=['marketing', 'mailing', 'POTC'],
) as dag:
    ...
    # RECIPIENT_EMAILS = ['chosw2@joycity.com', 'mirmir@ndream.com', 'gon0505@ndream.com', 'junezel@joycity.com', 'kyuny@joycity.com', 'bslee@joycity.com',
    ...
    def extract_and_send_email(**context):
        ...
        try:
                                ...
                                <tbody>
                                    <tr>
                                        <td style="white-space: nowrap" class="tableTitleNewMain">
                                            📊 POTC UA Performance & Cost Report :: {current_time} (KST)
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
            ...
            msg['Subject'] = f"[POTC] UA Performance & Cost Report {today}"
