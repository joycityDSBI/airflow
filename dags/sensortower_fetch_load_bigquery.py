...
APP_ID = '58dca1bc62d7d432f50018e9'
...
def sensortower_download_revenue_api(start_date, end_date, APP_ID, SENSORTOWER_TOKEN):
    ...
    # 다운로드와 매출액 API 호출
    downloads_revenue_url = f"https://api.sensortower.com/v1/unified/sales_report_estimates?app_ids={APP_ID}&date_granularity=daily&start_date={start_date}&end_date={end_date}&data_model=DM_2025_Q2&auth_token={SENSORTOWER_TOKEN}"
