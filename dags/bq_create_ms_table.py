...
with DAG(
    ...
    POTC_standard_creative_list = BigQueryInsertJobOperator(
    ...
    GBTW_standard_creative_list = BigQueryInsertJobOperator(
    ...
    GBTW_Old_standard_creative_list = BigQueryInsertJobOperator(
    ...
    WWM_standard_creative_list = BigQueryInsertJobOperator(
    ...
    DS_standard_creative_list = BigQueryInsertJobOperator(
    ...
    DRB_standard_creative_list = BigQueryInsertJobOperator(
    ...
    JYWN_standard_creative_list = BigQueryInsertJobOperator(
    ...
    BSTD_standard_creative_list = BigQueryInsertJobOperator(
    ...
    RESU_standard_creative_list = BigQueryInsertJobOperator(
    ...
    all_standard_creative_list = BigQueryInsertJobOperator(
    ...
    [ 
        POTC_standard_creative_list, 
        GBTW_standard_creative_list,
        GBTW_Old_standard_creative_list,
        WWM_standard_creative_list,
        DS_standard_creative_list,
        DRB_standard_creative_list,
        JYWN_standard_creative_list,
        BSTD_standard_creative_list,
        RESU_standard_creative_list 
    ] >> all_standard_creative_list >> task_send_email
